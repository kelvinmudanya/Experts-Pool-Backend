from core.models import Occupation, OccupationCategory
...
Occupation(name='Food safety', occupation_category=OccupationCategory.objects.filter(name='Food subsector').first())
Occupation(name='Food safety', occupation_category=OccupationCategory.objects.filter(name='Food subsector').first())
Occupation(name='Computer Scientist', occupation_category=OccupationCategory.objects.filter(
    name='Information communication Technology(ICT)').first())
Occupation(name='Anthropology', occupation_category=OccupationCategory.objects.filter(name='Anthropology').first())
Occupation(name='Environmental expert ',
           occupation_category=OccupationCategory.objects.filter(name='Environment').first())
Occupation(name='Veterinarian',
           occupation_category=OccupationCategory.objects.filter(name='Animal Health Sector').first())
Occupation(name='Animal scientist',
           occupation_category=OccupationCategory.objects.filter(name='Animal Health Sector').first())
Occupation(name='Wildlife Science', occupation_category=OccupationCategory.objects.filter(name='Wildlife').first())
